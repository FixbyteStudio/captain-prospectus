...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* Radix's Dialog.Root renders no DOM of its own, so this header must
            sit inside DialogContent (portalled, mounted only while open) —
            outside it, the h2/description would sit in the top bar
            permanently, open or not. */}
