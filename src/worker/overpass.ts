...
import type { OverpassCandidate } from "../shared/schemas";
 ...
 */
function toCandidate(element: OverpassElement): OverpassCandidate | null {
...
export function toCandidates(
  body: string,
): { candidates: OverpassCandidate[]; truncated: boolean } | null {
  let parsed: unknown;
  try {
